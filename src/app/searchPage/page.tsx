...
const newsData: NewsItem[] = [
    {
        id: 1,
        title: "Ethereum Enfrenta 'Crise de Meia-Idade' com Concorrência Aumentando",
        category: 'Cripto',
        content:
    ...
    {
        id: 2,
        title: 'Solana Supera Bitcoin e Ethereum em Valorização e Atração de Capital',
        category: 'Cripto',
        content:
    ...
    {
        id: 4,
        title: 'Jornalistas criticam fala do jogador Raphinha após derrota da seleção',
        category: 'Esportes',
        content:
    ...
    {
        id: 6,
        title: 'Preço do ovo sobe quase 20% em março, segundo IPCA-15; entenda quando pode baixar',
        category: 'Geral',
        content:
